...
%   matrix RHO, growth rates ALPHA, and noise magnitudes EPSILON. ALPHA and
%   EPSILON must be finite real floating-point scalars or length N vectors. DT
%   is a positive floating-point scalar specifying the integration step size.
%
