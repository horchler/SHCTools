...
if lt > 0
    ...
    ic(1,n) = 0;
    ti1 = t(i1(1)-1)+(t(i1(1))-t(i1(1)-1))*(bet-delta-a(i1(1)...
    ...
    for i = 1:lt
        ...
        i1i2 = i1(i+1);
        j1i2 = j1(i+1);
        ti12 = t(i1i2-1)+(t(i1i2)-t(i1i2-1))*(bet-delta-a(i1i2...
            -1,j1i2))/(a(i1i2,j1i2)-a(i1i2-1,j1i2));
        if nargout ~= 1
            i2i = i2(i);
            j2i = j2(i);
            ti2 = t(i2i-1)+(t(i2i)-t(i2i-1))*(bet-delta-a(i2i...
                -1,j2i))/(a(i2i,j2i)-a(i2i-1,j2i));
            tp{j1i}(icj) = ti2-ti1;
            tt{j1i}(icj) = ti12-ti2;
            if nargout == 4
                ti{j1i}(icj) = ti1;
